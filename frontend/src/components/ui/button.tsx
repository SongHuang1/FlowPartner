    ...
    return (
      <button
        className={cn(
          ...
          {
            'bg-neutral-900 text-neutral-50 shadow hover:bg-neutral-900/90': variant === 'default',
            'hover:bg-neutral-100 hover:text-neutral-900': variant === 'ghost',
            'border border-neutral-200 bg-transparent shadow-sm hover:bg-neutral-100 hover:text-neutral-900': variant === 'outline',
          },
          {
